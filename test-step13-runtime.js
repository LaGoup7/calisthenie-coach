...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.138'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.138')&&swSource.includes('web-push-manager.js?v=10.138'),'v10.138 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-138-quick-favorite-presets"),'v10.138 cache missing');
  ok(pkg.version==='10.138.0','package version is not 10.138.0');
