...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.133'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.133')&&swSource.includes('web-push-manager.js?v=10.133'),'v10.133 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-133-today-hotfix"),'v10.133 cache missing');
