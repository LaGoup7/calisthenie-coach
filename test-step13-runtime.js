...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.136'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.136')&&swSource.includes('web-push-manager.js?v=10.136'),'v10.136 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-136-quick-favorites"),'v10.136 cache missing');
  ok(pkg.version==='10.136.0','package version is not 10.136.0');
