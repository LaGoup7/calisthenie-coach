...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.142'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.142')&&swSource.includes('web-push-manager.js?v=10.142'),'v10.142 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-142-planning-heatmap"),'v10.142 cache missing');
  ok(pkg.version==='10.142.0','package version is not 10.142.0');
