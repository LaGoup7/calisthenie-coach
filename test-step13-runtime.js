...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.146'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.146')&&swSource.includes('web-push-manager.js?v=10.146'),'v10.146 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-146-progression-final"),'v10.146 cache missing');
  ok(pkg.version==='10.146.0','package version is not 10.146.0');
