...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.140'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.140')&&swSource.includes('web-push-manager.js?v=10.140'),'v10.140 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-140-today-activity"),'v10.140 cache missing');
