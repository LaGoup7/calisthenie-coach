...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.139'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.139')&&swSource.includes('web-push-manager.js?v=10.139'),'v10.139 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-139-search-hotfix"),'v10.139 cache missing');
  ok(pkg.version==='10.139.0','package version is not 10.139.0');
