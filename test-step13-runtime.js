...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.145'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.145')&&swSource.includes('web-push-manager.js?v=10.145'),'v10.145 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-145-mobility-final"),'v10.145 cache missing');
  ok(pkg.version==='10.145.0','package version is not 10.145.0');
