...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.131'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.131')&&swSource.includes('web-push-manager.js?v=10.131'),'v10.131 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-131-integrity-lot-a"),'v10.131 cache missing');
