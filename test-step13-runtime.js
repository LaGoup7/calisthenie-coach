...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.129'&&diagnostic.webPushManager==='1.2.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.129')&&swSource.includes('web-push-manager.js?v=10.129'),'v10.129 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-129-vercel-hobby-hotfix"),'v10.129 cache missing');
  ok(pkg.version==='10.129.0','package version is not 10.129.0');
