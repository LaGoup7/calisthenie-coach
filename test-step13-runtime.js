...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.137'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.137')&&swSource.includes('web-push-manager.js?v=10.137'),'v10.137 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-137-quick-log-journal"),'v10.137 cache missing');
