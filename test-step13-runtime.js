...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.135'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.135')&&swSource.includes('web-push-manager.js?v=10.135'),'v10.135 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-135-premium-add-hub"),'v10.135 cache missing');
