...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.144'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.144')&&swSource.includes('web-push-manager.js?v=10.144'),'v10.144 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-144-programs-premium"),'v10.144 cache missing');
