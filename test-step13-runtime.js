...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.132'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.132')&&swSource.includes('web-push-manager.js?v=10.132'),'v10.132 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-132-ux-lot-b"),'v10.132 cache missing');
