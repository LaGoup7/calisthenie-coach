...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.143'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.143')&&swSource.includes('web-push-manager.js?v=10.143'),'v10.143 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-143-planning-final"),'v10.143 cache missing');
