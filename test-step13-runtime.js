...
(async()=>{
  ...
  ok(diagnostic.appVersion==='10.130'&&diagnostic.webPushManager==='1.3.0','diagnostic version metadata incorrect');
  ...
  ok(html.includes('web-push-manager.js?v=10.130')&&swSource.includes('web-push-manager.js?v=10.130'),'v10.130 manager missing from PWA asset chain');
  ok(swSource.includes("kinetik-v10-130-multidevice-account"),'v10.130 cache missing');
  ok(pkg.version==='10.130.0','package version is not 10.130.0');
