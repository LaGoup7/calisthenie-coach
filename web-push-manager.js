...
(function(global){
  ...
  function deviceMetadata(){
    ...
    return {label:sanitizeLabel(state.deviceLabel),platform:detectPlatform(),standalone:isStandalone(),appVersion:'10.141'};
  }
  function capability(){
  ...
  function supportDiagnostic(){
    ...
    return {
      schema:'kinetik-support-diagnostic-v1',generatedAt:new Date().toISOString(),appVersion:'10.141',webPushManager:VERSION,
