...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.146')&&sw.includes('account-manager.js?v=10.146'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.146')>html.indexOf('web-push-manager.js?v=10.146'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-146-progression-final'),'v10.146 cache missing');ok(pkg.version==='10.146.0','package version mismatch');
