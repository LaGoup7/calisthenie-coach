...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.138')&&sw.includes('account-manager.js?v=10.138'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.138')>html.indexOf('web-push-manager.js?v=10.138'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-138-quick-favorite-presets'),'v10.138 cache missing');ok(pkg.version==='10.138.0','package version mismatch');
