...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.143')&&sw.includes('account-manager.js?v=10.143'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.143')>html.indexOf('web-push-manager.js?v=10.143'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-143-planning-final'),'v10.143 cache missing');ok(pkg.version==='10.143.0','package version mismatch');
