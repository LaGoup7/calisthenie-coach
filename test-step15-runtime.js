...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.137')&&sw.includes('account-manager.js?v=10.137'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.137')>html.indexOf('web-push-manager.js?v=10.137'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-137-quick-log-journal'),'v10.137 cache missing');ok(pkg.version==='10.137.0','package version mismatch');
