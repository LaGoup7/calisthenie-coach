...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.133')&&sw.includes('account-manager.js?v=10.133'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.133')>html.indexOf('web-push-manager.js?v=10.133'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-133-today-hotfix'),'v10.133 cache missing');ok(pkg.version==='10.133.0','package version mismatch');
