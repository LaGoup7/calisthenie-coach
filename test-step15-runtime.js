...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.135')&&sw.includes('account-manager.js?v=10.135'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.135')>html.indexOf('web-push-manager.js?v=10.135'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-135-premium-add-hub'),'v10.135 cache missing');ok(pkg.version==='10.135.0','package version mismatch');
