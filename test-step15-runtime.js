...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.141')&&sw.includes('account-manager.js?v=10.141'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.141')>html.indexOf('web-push-manager.js?v=10.141'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-141-today-cleanup'),'v10.141 cache missing');ok(pkg.version==='10.141.0','package version mismatch');
