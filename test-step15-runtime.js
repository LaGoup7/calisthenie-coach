...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.136')&&sw.includes('account-manager.js?v=10.136'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.136')>html.indexOf('web-push-manager.js?v=10.136'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-136-quick-favorites'),'v10.136 cache missing');ok(pkg.version==='10.136.0','package version mismatch');
