...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.144')&&sw.includes('account-manager.js?v=10.144'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.144')>html.indexOf('web-push-manager.js?v=10.144'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-144-programs-premium'),'v10.144 cache missing');ok(pkg.version==='10.144.0','package version mismatch');
