...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.145')&&sw.includes('account-manager.js?v=10.145'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.145')>html.indexOf('web-push-manager.js?v=10.145'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-145-mobility-final'),'v10.145 cache missing');ok(pkg.version==='10.145.0','package version mismatch');
