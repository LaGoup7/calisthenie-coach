...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.142')&&sw.includes('account-manager.js?v=10.142'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.142')>html.indexOf('web-push-manager.js?v=10.142'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-142-planning-heatmap'),'v10.142 cache missing');ok(pkg.version==='10.142.0','package version mismatch');
