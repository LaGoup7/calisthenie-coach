...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.139')&&sw.includes('account-manager.js?v=10.139'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.139')>html.indexOf('web-push-manager.js?v=10.139'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-139-search-hotfix'),'v10.139 cache missing');ok(pkg.version==='10.139.0','package version mismatch');
