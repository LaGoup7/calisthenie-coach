...
(async()=>{
  ...
  ok(html.includes('account-manager.js?v=10.140')&&sw.includes('account-manager.js?v=10.140'),'account manager missing from PWA chain');ok(html.indexOf('account-manager.js?v=10.140')>html.indexOf('web-push-manager.js?v=10.140'),'account manager load order is incorrect');ok(sw.includes('kinetik-v10-140-today-activity'),'v10.140 cache missing');ok(pkg.version==='10.140.0','package version mismatch');
