/* KINETIK v10.140 · Account & multi-device manager (local-first identity only). */
(function(global){
  'use strict';
  const VERSION='1.0.0';
  ...
  function deviceMeta(){return{label:label(),platform:detectPlatform(),standalone:standalone(),appVersion:'10.140'};}
