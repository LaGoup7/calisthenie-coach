...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.146 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.146'),'v10.146 asset version missing');
