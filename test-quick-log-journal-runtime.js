...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.141 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.141'),'v10.141 asset version missing');
ok(sw.includes('kinetik-v10-141-today-cleanup'),'v10.141 service worker cache missing');
