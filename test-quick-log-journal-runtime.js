...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.145 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.145'),'v10.145 asset version missing');
