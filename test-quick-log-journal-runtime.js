...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.144 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.144'),'v10.144 asset version missing');
