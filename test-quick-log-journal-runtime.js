...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.139 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.139'),'v10.139 asset version missing');
ok(sw.includes('kinetik-v10-139-search-hotfix'),'v10.139 service worker cache missing');
