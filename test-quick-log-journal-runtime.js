...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.142 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.142'),'v10.142 asset version missing');
