...
ok(styles.includes('v10.137 · Quick Log band fit + deletable journal'),'v10.140 journal styles missing');
...
ok(htmlFile.includes('app.js?v=10.140'),'v10.140 asset version missing');
ok(sw.includes('kinetik-v10-140-today-activity'),'v10.140 service worker cache missing');
