const CACHE = 'kinetik-v10-50-assessment-center';
const ASSETS = ['./','./index.html','./styles.css?v=10.50','./app.js?v=10.50','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
