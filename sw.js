const CACHE = 'kinetik-v10-85-progression-chain';
const ASSETS = ['./','./index.html','./styles.css?v=10.85','./app.js?v=10.85','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
