const CACHE = 'kinetik-v10-71-planning-readability';
const ASSETS = ['./','./index.html','./styles.css?v=10.71','./app.js?v=10.71','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
