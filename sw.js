const CACHE = 'kinetik-v10-86-performance-only-ranks';
const ASSETS = ['./','./index.html','./styles.css?v=10.86','./app.js?v=10.86','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
