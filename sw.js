const CACHE = 'kinetik-v10-82-product-vocabulary';
const ASSETS = ['./','./index.html','./styles.css?v=10.82','./app.js?v=10.82','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
