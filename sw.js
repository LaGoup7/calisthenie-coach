const CACHE = 'kinetik-v10-150-profile-control-center';
const ASSETS = ['./','./index.html','./styles.css?v=10.150','./app.js?v=10.150','./app-adaptive.js?v=10.148','./app-planning.js?v=10.148','./app-progress.js?v=10.150','./app-body.js?v=10.148','./app-journey.js?v=10.148','./daily-tasks.js?v=10.148','./local-reminders.js?v=10.148','./web-push-manager.js?v=10.148','./account-manager.js?v=10.148','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
