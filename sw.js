const CACHE = 'kinetik-v10-72-planning-day-separation';
const ASSETS = ['./','./index.html','./styles.css?v=10.72','./app.js?v=10.72','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
