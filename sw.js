const CACHE = 'kinetik-v10-97-remove-progress-chain';
const ASSETS = ['./','./index.html','./styles.css?v=10.97','./app.js?v=10.97','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
