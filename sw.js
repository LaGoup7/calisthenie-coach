const CACHE = 'kinetik-v10-92-progress-chain-simplified';
const ASSETS = ['./','./index.html','./styles.css?v=10.92','./app.js?v=10.92','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
