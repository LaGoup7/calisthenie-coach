const CACHE = 'kinetik-v10-78-planning-consistency';
const ASSETS = ['./','./index.html','./styles.css?v=10.78','./app.js?v=10.78','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
