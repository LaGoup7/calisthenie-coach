const CACHE = 'kinetik-v10-93-chain-navigation-fix';
const ASSETS = ['./','./index.html','./styles.css?v=10.93','./app.js?v=10.93','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
