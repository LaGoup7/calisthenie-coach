const CACHE = 'kinetik-v10-96-body-overview-fix';
const ASSETS = ['./','./index.html','./styles.css?v=10.96','./app.js?v=10.96','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
