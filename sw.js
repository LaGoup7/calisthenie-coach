const CACHE = 'kinetik-v10-32-today-mobility-audit';
const ASSETS = ['./','./index.html','./styles.css?v=10.32','./app.js?v=10.32','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
