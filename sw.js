const CACHE = 'kinetik-v10-137-quick-log-journal';
const ASSETS = ['./','./index.html','./styles.css?v=10.137','./app.js?v=10.137','./app-adaptive.js?v=10.137','./app-planning.js?v=10.137','./app-progress.js?v=10.137','./app-body.js?v=10.137','./app-journey.js?v=10.137','./daily-tasks.js?v=10.137','./local-reminders.js?v=10.137','./web-push-manager.js?v=10.137','./account-manager.js?v=10.137','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
