const CACHE = 'kinetik-v10-98-deploy-root-fix';
const ASSETS = ['./','./index.html','./styles.css?v=10.98','./app.js?v=10.98','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
