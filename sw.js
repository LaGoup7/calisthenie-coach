const CACHE = 'kinetik-v10-76-planning-visual-clarity';
const ASSETS = ['./','./index.html','./styles.css?v=10.76','./app.js?v=10.76','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
