const CACHE = 'kinetik-v10-80-progression-visual-clarity';
const ASSETS = ['./','./index.html','./styles.css?v=10.80','./app.js?v=10.80','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
