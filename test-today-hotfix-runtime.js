...
const core=today.indexOf('class="today-core-timer"');
...
ok(cockpit<core,'Gainage should be immediately available after primary shortcuts');
...
ok(html.includes('app.js?v=10.133')&&html.includes('app-journey.js?v=10.133'),'v10.133 assets missing');
ok(sw.includes('kinetik-v10-133-today-hotfix'),'v10.133 service worker cache missing');
ok(pkg.version==='10.133.0','package is not v10.133.0');
