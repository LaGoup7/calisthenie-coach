...
ok(html.includes('app.js?v=10.146')&&html.includes('account-manager.js?v=10.146'),'v10.146 asset chain missing');
ok(sw.includes('kinetik-v10-146-progression-final')&&sw.includes('app-journey.js?v=10.146'),'v10.146 PWA cache missing');
