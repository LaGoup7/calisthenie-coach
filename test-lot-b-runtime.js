...
ok(html.includes('app.js?v=10.142')&&html.includes('account-manager.js?v=10.142'),'v10.142 asset chain missing');
ok(sw.includes('kinetik-v10-142-planning-heatmap')&&sw.includes('app-journey.js?v=10.142'),'v10.142 PWA cache missing');
