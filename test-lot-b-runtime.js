...
ok(html.includes('app.js?v=10.145')&&html.includes('account-manager.js?v=10.145'),'v10.145 asset chain missing');
ok(sw.includes('kinetik-v10-145-mobility-final')&&sw.includes('app-journey.js?v=10.145'),'v10.145 PWA cache missing');
