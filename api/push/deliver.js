const { json,readJson,safeId,dateKeyInTimezone,getDevice,putDevice,deleteDevice,claimDelivery,releaseDelivery,deleteSchedule,cancelMessage,deterministicScheduleId,withHealth,deliveryErrorCode }=require('../_lib/push-core');
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    device=withHealth(device,{lastDeliveryAcceptedAt:new Date().toISOString(),lastDeliveryReason:reason,lastDeliveryDate:dateKey,lastDeliveryErrorAt:null,lastDeliveryError:null,consecutiveFailures:0});
