...
(async()=>{
  ...
  ok(manager&&manager.version==='1.0.0','Web Push manager missing or wrong version');
  ...
  ok(sw.includes('web-push-manager.js?v=10.125')&&html.includes('web-push-manager.js?v=10.125'),'Web Push manager is not in PWA asset chain');
