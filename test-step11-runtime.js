...
(async()=>{
  ...
  ok(manager&&manager.version==='1.1.0','Web Push manager missing or wrong version');
  ...
  ok(sw.includes('web-push-manager.js?v=10.126')&&html.includes('web-push-manager.js?v=10.126'),'Web Push manager is not in PWA asset chain');
