...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.136','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.136')&&sw.includes('web-push-manager.js?v=10.136'),'v10.136 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-136-quick-favorites"),'v10.136 cache name missing');
  ok(pkg.version==='10.136.0','package version not updated');
