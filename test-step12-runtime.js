...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.132','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.132')&&sw.includes('web-push-manager.js?v=10.132'),'v10.132 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-132-ux-lot-b"),'v10.132 cache name missing');
  ok(pkg.version==='10.132.0','package version not updated');
