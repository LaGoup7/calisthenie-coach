...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.144','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.144')&&sw.includes('web-push-manager.js?v=10.144'),'v10.144 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-144-programs-premium"),'v10.144 cache name missing');
  ok(pkg.version==='10.144.0','package version not updated');
