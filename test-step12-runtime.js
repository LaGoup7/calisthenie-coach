...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.139','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.139')&&sw.includes('web-push-manager.js?v=10.139'),'v10.139 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-139-search-hotfix"),'v10.139 cache name missing');
  ok(pkg.version==='10.139.0','package version not updated');
