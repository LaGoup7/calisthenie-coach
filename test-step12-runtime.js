...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.141','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.141')&&sw.includes('web-push-manager.js?v=10.141'),'v10.141 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-141-today-cleanup"),'v10.141 cache name missing');
  ok(pkg.version==='10.141.0','package version not updated');
