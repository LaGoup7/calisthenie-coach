...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.135','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.135')&&sw.includes('web-push-manager.js?v=10.135'),'v10.135 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-135-premium-add-hub"),'v10.135 cache name missing');
  ok(pkg.version==='10.135.0','package version not updated');
