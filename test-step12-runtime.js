...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.133','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.133')&&sw.includes('web-push-manager.js?v=10.133'),'v10.133 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-133-today-hotfix"),'v10.133 cache name missing');
  ok(pkg.version==='10.133.0','package version not updated');
