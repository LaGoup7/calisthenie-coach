...
(async()=>{
  ...
  ok(syncPayload?.device?.appVersion==='10.140','device app version missing');
  ...
  ok(html.includes('web-push-manager.js?v=10.140')&&sw.includes('web-push-manager.js?v=10.140'),'v10.140 Web Push manager not in PWA asset chain');
  ok(sw.includes("kinetik-v10-140-today-activity"),'v10.140 cache name missing');
  ok(pkg.version==='10.140.0','package version not updated');
