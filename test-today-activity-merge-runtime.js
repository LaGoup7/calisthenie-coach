...
ok(out.today.includes(`rank-cockpit rank-${out.rank}`),'Today rank shortcut is missing the active rank color class');
ok(out.rank==='bronze' ? out.today.includes('rank-cockpit rank-bronze') : true,'Bronze shortcut color class missing');
const styles=fs.readFileSync(path.join(__dirname,'styles.css'),'utf8');
ok(styles.includes('v10.140 · Today activity summary + rank color fix'),'v10.140 Today activity styles missing');
ok(styles.includes('.today-primary-shortcuts .rank-cockpit[class*="rank-"]'),'rank palette hardening missing');
...
ok(html.includes('app.js?v=10.140')&&html.includes('app-journey.js?v=10.140'),'v10.140 asset chain missing');
