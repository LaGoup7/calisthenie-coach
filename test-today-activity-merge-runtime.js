...
ok(styles.includes('v10.141 · Today cleanup — rank merged into À surveiller'),'v10.141 Today cleanup styles missing');
...
ok(html.includes('app.js?v=10.141')&&html.includes('app-journey.js?v=10.141'),'v10.141 asset chain missing');
