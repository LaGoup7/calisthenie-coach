...
ok(styles.includes('v10.141 · Today cleanup — rank merged into À surveiller'),'v10.146 Today cleanup styles missing');
...
ok(html.includes('app.js?v=10.146')&&html.includes('app-journey.js?v=10.146'),'v10.146 asset chain missing');
