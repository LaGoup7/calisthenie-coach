...
ok(styles.includes('v10.141 · Today cleanup — rank merged into À surveiller'),'v10.142 Today cleanup styles missing');
...
ok(html.includes('app.js?v=10.142')&&html.includes('app-journey.js?v=10.142'),'v10.142 asset chain missing');
