...
ok(styles.includes('v10.141 · Today cleanup — rank merged into À surveiller'),'v10.145 Today cleanup styles missing');
...
ok(html.includes('app.js?v=10.145')&&html.includes('app-journey.js?v=10.145'),'v10.145 asset chain missing');
