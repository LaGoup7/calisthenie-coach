...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.144')&&html.includes('account-manager.js?v=10.144'),'v10.144 assets missing from index');
  ok(sw.includes('kinetik-v10-144-programs-premium')&&sw.includes('app-progress.js?v=10.144'),'v10.144 service-worker cache missing');
