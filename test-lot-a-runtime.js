...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.137')&&html.includes('account-manager.js?v=10.137'),'v10.137 assets missing from index');
  ok(sw.includes('kinetik-v10-137-quick-log-journal')&&sw.includes('app-progress.js?v=10.137'),'v10.137 service-worker cache missing');
