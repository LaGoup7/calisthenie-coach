...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.139')&&html.includes('account-manager.js?v=10.139'),'v10.139 assets missing from index');
  ok(sw.includes('kinetik-v10-139-search-hotfix')&&sw.includes('app-progress.js?v=10.139'),'v10.139 service-worker cache missing');
