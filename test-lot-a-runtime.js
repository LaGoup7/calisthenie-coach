...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.138')&&html.includes('account-manager.js?v=10.138'),'v10.138 assets missing from index');
  ok(sw.includes('kinetik-v10-138-quick-favorite-presets')&&sw.includes('app-progress.js?v=10.138'),'v10.138 service-worker cache missing');
