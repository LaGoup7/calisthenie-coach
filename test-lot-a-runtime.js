...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.135')&&html.includes('account-manager.js?v=10.135'),'v10.135 assets missing from index');
  ok(sw.includes('kinetik-v10-135-premium-add-hub')&&sw.includes('app-progress.js?v=10.135'),'v10.135 service-worker cache missing');
