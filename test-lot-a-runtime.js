...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.142')&&html.includes('account-manager.js?v=10.142'),'v10.142 assets missing from index');
  ok(sw.includes('kinetik-v10-142-planning-heatmap')&&sw.includes('app-progress.js?v=10.142'),'v10.142 service-worker cache missing');
