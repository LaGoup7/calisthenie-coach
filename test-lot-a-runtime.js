...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.143')&&html.includes('account-manager.js?v=10.143'),'v10.143 assets missing from index');
  ok(sw.includes('kinetik-v10-143-planning-final')&&sw.includes('app-progress.js?v=10.143'),'v10.143 service-worker cache missing');
