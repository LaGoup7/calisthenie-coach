...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.136')&&html.includes('account-manager.js?v=10.136'),'v10.136 assets missing from index');
  ok(sw.includes('kinetik-v10-136-quick-favorites')&&sw.includes('app-progress.js?v=10.136'),'v10.136 service-worker cache missing');
