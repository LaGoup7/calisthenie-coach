...
(async()=>{
  ...
  ok(html.includes('app.js?v=10.145')&&html.includes('account-manager.js?v=10.145'),'v10.145 assets missing from index');
  ok(sw.includes('kinetik-v10-145-mobility-final')&&sw.includes('app-progress.js?v=10.145'),'v10.145 service-worker cache missing');
