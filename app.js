/* KINETIK v10.158 · iPhone layout, focused Today agenda and athlete setup. */
...
async function exportBackup(){
  ...
  const backup={app:'KINETIK',schema:2,version:'10.158',exportedAt:new Date().toISOString(),data,photos};
