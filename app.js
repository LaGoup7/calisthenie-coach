...
renderProgressOverview=function(){
  ...
  <section class="progress-week-context"><div><div class="kicker">Bloc actuel · ${esc(getActiveTrainingCycle().name)}</div><strong>${esc(x.c.name)}</strong><span>Semaine ${x.c.week}/${x.c.weekCount} · ${x.c.rir} RIR · ${Math.round(x.c.setFactor*100)} % volume</span></div><div class="progress-week-badge"><strong>${x.c.week}</strong><span>/ ${x.c.weekCount}</span></div></section>
