/* KINETIK v10.146 · Core runtime, data, storage and foundational UI. */
...
async function exportBackup(){
  ...
  const backup={app:'KINETIK',schema:2,version:'10.146',exportedAt:new Date().toISOString(),data,photos};
