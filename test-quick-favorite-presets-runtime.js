...
ok(styles.includes('v10.139 · Quick favorite custom presets + search repair'),'v10.144 preset styles missing');
...
ok(html.includes('app.js?v=10.144')&&sw.includes('kinetik-v10-144-programs-premium'),'v10.144 PWA chain missing');
