...
ok(styles.includes('v10.139 · Quick favorite custom presets + search repair'),'v10.140 preset styles missing');
...
ok(html.includes('app.js?v=10.140')&&sw.includes('kinetik-v10-140-today-activity'),'v10.140 PWA chain missing');
