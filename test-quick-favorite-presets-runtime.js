...
ok(styles.includes('v10.139 · Quick favorite custom presets + search repair'),'v10.139 preset styles missing');
...
ok(html.includes('app.js?v=10.139')&&sw.includes('kinetik-v10-139-search-hotfix'),'v10.139 PWA chain missing');
ok(pkg.version==='10.139.0','package version mismatch');
