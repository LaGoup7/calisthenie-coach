...
ok(styles.includes('v10.139 · Quick favorite custom presets + search repair'),'v10.146 preset styles missing');
...
ok(html.includes('app.js?v=10.146')&&sw.includes('kinetik-v10-146-progression-final'),'v10.146 PWA chain missing');
