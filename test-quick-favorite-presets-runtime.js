...
ok(styles.includes('v10.139 · Quick favorite custom presets + search repair'),'v10.143 preset styles missing');
...
ok(html.includes('app.js?v=10.143')&&sw.includes('kinetik-v10-143-planning-final'),'v10.143 PWA chain missing');
